...
class Application(db.Model):
    ...
    student = db.relationship('User', foreign_keys=[student_id], backref=db.backref('student_applications', lazy=True))
    staff = db.relationship('User', foreign_keys=[staff_id], backref=db.backref('staff_applications', lazy=True))
